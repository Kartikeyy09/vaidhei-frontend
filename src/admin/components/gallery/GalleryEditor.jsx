                        ...
                        >
                            <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                                <Dialog.Title as="h3" className="text-2xl font-bold leading-6 text-slate-900">
                                    {item ? 'Edit Gallery Item' : 'Add New Item to Gallery'}
                                </Dialog.Title>
                                <button
                                    onClick={onClose}
                                ...
                                <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2 grid grid-cols-2 gap-4">
                                            <button
                                                ...
                                                className={`flex items-center justify-center gap-2 px-4 py-2 rounded-md text-sm font-semibold transition-colors ${
                                                    formData.type === 'image'
                                    ...
                                    {formData.type === 'image' ? (
                                        <div>
                                            ...
                                            <div
                                                ...
                                                className={`flex justify-center rounded-lg border-2 border-dashed border-gray-300 p-6 cursor-pointer hover:border-red-500 ${
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="block w-full px-4 py-3 text-slate-800 bg-white border rounded-lg focus:outline-none focus:ring-0 border-gray-300 focus:border-red-600"
                                            required
                                        >
                                    ...
                                    <div className="pt-4 flex justify-end gap-4">
                                        <button
                                            type="button"
                                            onClick={onClose}
                                            className="px-6 py-2 rounded-md text-slate-700 bg-slate-100 hover:bg-slate-200 font-semibold disabled:opacity-50"
                                            disabled={isSaving}
                                        >
                                            Cancel
                                        </button>
                                        <button
                                            type="submit"
                                            className="px-6 py-2 rounded-md text-white bg-red-600 hover:bg-red-700 font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                                            disabled={isSaving}
                                        >
